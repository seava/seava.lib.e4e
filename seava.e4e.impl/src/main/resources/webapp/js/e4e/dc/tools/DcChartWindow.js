 ...
 */
Ext.define("e4e.dc.tools.DcChartWindow", {
	extend : "Ext.Window",
	title : Main.translate("cmp", "chart_title"),
	border : true,
	width : 350,
	resizable : false,
	closable : true,
	...
	items : {
		...
		items : [ {
			name : "fld_type",
			fieldLabel : Main.translate("cmp", "chart_type"),
			xtype : "combo",
			forceSelection : true,
			triggerAction : "all",
			store : [ "line" ],
			...
			name : "fld_title",
			fieldLabel : Main.translate("cmp", "chart_title"),
			xtype : "textfield",
			value : "Chart"

		}, {
			name : "fld_x",
			fieldLabel : Main.translate("cmp", "chart_x"),
			xtype : "combo",
			...
			name : "fld_y",
			fieldLabel : Main.translate("cmp", "chart_y"),
			xtype : "combo",
			forceSelection : false,
			triggerAction : "all",
			store : []
		...
		executeTask : function() {
			...
			var url = '/nan21.e4e.web/chart/' + ctrl.dsName + '?';
