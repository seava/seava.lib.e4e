 ...
 */
Ext.define("e4e.dc.view.AbstractDcvTree", {
	...
	initComponent : function(config) {
		...
		var cfg = {
			...
			loader : new Ext.tree.TreeLoader({
				...
				clearOnLoad : false,
				dataUrl : Main.dsAPI("OrganizationHierarchyItem", "json").read

			})
		}

		Ext.apply(cfg.loader, {
			processResponse : this.processResponseHandler,
			requestData : this.requestDataHandler
		});
	...
	requestDataHandler : function(node, callback, scope) {
	...
	processResponseHandler : function(response, node, callback, scope) {
