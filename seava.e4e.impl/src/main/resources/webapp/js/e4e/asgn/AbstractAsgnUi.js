 ...
 */
Ext.define("e4e.asgn.AbstractAsgnUi", {
	...
	_doQueryLeftImpl_ : function() {
		...
		if (Ext.isEmpty(f.field) && !Ext.isEmpty(f.value)) {
			Ext.Msg.show({
				...
				msg : Main.translate("asgn", "select_filter_field__msg"),
				buttons : Ext.Msg.OK
			});
			return;
		}
	...
	_defineDefaultElements_ : function() {
		...
		this._elems_.add("leftFilterBtn", {
			xtype : "button",
			text : Main.translate("asgn", "btn_ok__lbl"),
			scope : this,
			handler : function() {
				this._doQueryLeft_();
			}
		...
		this._elems_.add("leftFilter", {
			fieldLabel : Main.translate("asgn", "filter__lbl"),
	...
	_buildToolbarItems_ : function() {
		...
		return [
				{
					xtype : "button",
					text : Main.translate("asgn", "cancel__lbl"),
					tooltip : Main.translate("asgn", "cancel__tlp"),
				...
				},
				{
					...
					xtype : "button",
					text : Main.translate("asgn", "save__lbl"),
					tooltip : Main.translate("asgn", "save__tlp"),
					id : this._btnSaveId_,
					scope : this,
					handler : function() {
